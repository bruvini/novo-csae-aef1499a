...
const CHANGELOGS_SISTEMA: { titulo: string; descricao: string; dataHora?: Timestamp }[] = [
  ...
  },
  {
    ...
    dataHora: Timestamp.fromDate(new Date('2026-06-08T08:00:00')),
  },
  {
    ...
    dataHora: Timestamp.fromDate(new Date('2026-06-08T08:05:00')),
  },
  {
    ...
    dataHora: Timestamp.fromDate(new Date('2026-06-08T08:10:00')),
  },
];

...
import { DiagnosticoCompleto, ResultadoEsperado, Subconjunto, Intervencao } from '@/services/bancodados/tipos';
...
interface FormDiagnosticoProps {
  ...
  setTipoSubconjuntoSelecionado: React.Dispatch<React.SetStateAction<'Protocolo' | 'NHB'>>;
  ...
  onAtualizarResultadoEsperado: (index: number, campo: keyof ResultadoEsperado, valor: any) => void;
    ...
    <div className="grid gap-4 py-4">
      ...
      <div className="grid gap-2">
        <div className="flex justify-between items-center">
          ...
          <Button type="button" variant="outline" size="sm" onClick={onAdicionarResultadoEsperado}>

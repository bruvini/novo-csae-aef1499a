...
const TermoResponsabilidadeModal: React.FC<TermoResponsabilidadeModalProps> = ({
  ...
  const incluirCoren = () => {
    return (
      dadosUsuario.formacao === "Enfermeiro" ||
  ...
  const handleAceitar = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "O PDF foi gerado e aberto em uma nova aba. Seu cadastro será processado.",
      });
    } catch (error) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh]">
        ...
        <ScrollArea className="h-[60vh] pr-4">
          <div
            ...
            className="p-6 bg-white text-justify leading-relaxed"
          >
            ...
            <p className="mb-4">
              Eu, <strong>{dadosUsuario.nomeCompleto}</strong>,{" "}
              <strong>{dadosUsuario.formacao}</strong>
              {gerarTextoCoren()}, residente e domiciliado em {dadosUsuario.rua}
              , Nº {dadosUsuario.numero}, Bairro {dadosUsuario.bairro},{" "}
              {dadosUsuario.cidade}/{dadosUsuario.uf}, portador da Cédula de
              Identidade R.G. nº {formatarRG(dadosUsuario.rg)}, inscrito no CPF
              sob o nº {formatarCPF(dadosUsuario.cpf)}.
            </p>

            <p className="mb-4">
              <strong>ASSUMO</strong> a responsabilidade de participar como
              Piloto do Registro do Processo de Enfermagem, utilizando a
              Classificação Internacional para a Prática de Enfermagem (CIPE) e
              o endereço eletrônico www.csae.com.br no Centro de Saúde que estou
              alocado, conforme orientações fornecidas pela Comissão Permanente
              da Sistematização da Assistência de Enfermagem (CSAE) –
              Subcomissão CIPE Protocolos de Enfermagem da Secretaria Municipal
              de Saúde (SMS) de Florianópolis.
            </p>

            <p className="mb-4">
              <strong>DECLARO</strong> seguir os princípios e diretrizes
              combinadas no processo de trabalho.
            </p>

            <p className="mb-4">
              <strong>DECLARO</strong> ser de minha ciência que os dados
              contidos neste Piloto pertencem à SMS de Florianópolis, portanto,
              é de minha responsabilidade NÃO compartilhar com pessoas externas
              ao projeto os instrumentos e materiais disponibilizados,
            ...
            <p className="mb-4">
              <strong>DECLARO</strong> não utilizar as informações confidenciais
              a que tiver acesso, para gerar benefício próprio exclusivo e/ou
              unilateral, presente ou futuro, ou para o uso de terceiros.
            </p>

            <p className="mb-4">
              <strong>DECLARO</strong> ser da minha ciência que todos os dados
              que porventura forem utilizados para fins de pesquisa e extensão,
              deverão ser autorizados pela CSAE e Responsabilidade Técnica de
              Enfermagem.
            </p>

...
const WelcomePanel = () => {
  return <div className="relative w-full h-full overflow-hidden bg-gradient-to-br from-csae-green-600 to-csae-green-800 rounded-lg shadow-lg animate-zoom-in">
      ...
      <div className="relative flex flex-col items-center justify-center h-full px-8 py-12 text-white">
        <img src="/lovable-uploads/6d9cba4c-ad70-4be0-a8ff-5eb1c6c2bed5.png" alt="Portal CSAE Floripa Logo" className="w-32 h-32 mb-8" />

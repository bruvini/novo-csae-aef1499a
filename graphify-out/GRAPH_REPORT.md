...
## Corpus Check
- 170 files · ~463,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1128 nodes · 2765 edges · 99 communities (47 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `972c84ed`
...
Cohesion: 0.06
Nodes (53): EtapaDiagnosticoProps, EtapaEvolucaoProps, EtapaImplementacaoProps, EtapaPlanejamentoProps, EtapaResumoProps, HistoricoProcessosModalProps, IntervencaoItemProps, ListaPacientes() (+45 more)
...
### Community 2 - "EtapaAvaliacao.tsx"
Cohesion: 0.06
Nodes (76): AchadoEditState, CLASSIFICACAO_SUGGESTIONS, emptyAchado(), emptyOpcao(), FormularioSistema(), FormularioSistemaProps, inferEhAlteracao(), sortedAchadosWithIndex() (+68 more)

### Community 3 - "EtapaDiagnostico.tsx"
Cohesion: 0.07
Nodes (44): ModalCadastroSubconjunto(), ModalCadastroSubconjuntoProps, ModalDetalhesSubconjuntoProps, ModalVisualizarDiagnosticoProps, inferEhAlteracao(), ModalVisualizarSistema(), sortedAchados(), ModalConfirmacaoAprovacaoProps (+36 more)
...
### Community 5 - "EtapaResumo.tsx"
Cohesion: 0.06
Nodes (50): queryClient, IndicadoresConteudo(), IndicadoresData, IndicadoresProducaoModalProps, AccessInfoFormProps, PersonalInfoFormProps, ProfessionalInfoFormProps, Card (+42 more)
...
### Community 11 - "ModalCadastroPaciente.tsx"
Cohesion: 0.14
Nodes (17): IntervencaoItem(), FormValues, ModalCadastroPaciente(), SelectContent, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton (+9 more)
...
Cohesion: 0.05
Nodes (32): react, react, LoadingOverlay(), LoadingOverlayProps, ProtectedRoute(), Carousel, CarouselApi, CarouselContent (+24 more)

### Community 18 - "ModalCadastroDiagnostico.tsx"
Cohesion: 0.16
Nodes (14): ModalCadastroDiagnostico(), Subconjunto, TabelaSubconjuntos(), DiagnosticoEnfermagem, IntervencaoEnfermagem, MaterialApoio, ResultadoEsperado, salvarDiagnostico() (+6 more)
...
Cohesion: 0.05
Nodes (80): AuthenticatedLayout(), AuthenticatedLayoutProps, Footer(), TabelaDiagnosticos(), ModalConfirmacaoAprovacao(), ModalConfirmacaoExclusao(), ModalMotivoRecusa(), Header() (+72 more)

### Community 101 - "Dashboard.tsx"
Cohesion: 0.17
Nodes (16): HeroBanner(), HeroBannerProps, ModalHistoricoChangelog(), ModalHistoricoChangelogProps, Dashboard(), formatarDataHora(), buscarChangelogsRecentes(), buscarTodosChangelogs() (+8 more)
